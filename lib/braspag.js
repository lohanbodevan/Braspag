(function(){
  ...
  var braspag = (function(){
    ...
    braspag.prototype.create = function(option, callback){
    ...
    braspag.prototype.consult = function(option, callback){
      this.params = options;
    ...
    braspag.prototype.capture = function(option, callback){
      this.config.body = JSON.stringify(options);
      if(this.env == 'consulta'){
    ...
    braspag.prototype.cancel = function(option, callback){
      this.config.body = JSON.stringify(options);
      if(this.env == 'consulta'){
